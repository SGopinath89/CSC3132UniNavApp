...
echo"<div class='mySlides fade'>";
  ...
  echo"<img src='resource/bimg/$im_1' style='width:1000px; height:600px' >";
  echo"<div class='text'>Caption one</div>";
echo"</div>";

echo"<div class='mySlides fade'>";
  echo"<div class='numbertext'>2 / 5</div>";
  echo"<img src='resource/bimg/$im_2' style='width:1000px; height:600px'>";
  echo"<div class='text'>Caption Two</div>";
echo"</div>";

echo"<div class='mySlides fade'>";
  echo"<div class='numbertext'>3 / 5</div>";
  echo"<img src='resource/bimg/$im_3' style='width:1000px; height:600px'>";
  echo"<div class='text'>Caption Three</div>";
echo"</div>";

echo"<div class='mySlides fade'>";
  echo"<div class='numbertext'>4 / 5</div>";
  echo"<img src='resource/bimg/$im_4' style='width:1000px; height:600px'>";
  echo"<div class='text'>Caption four</div>";
echo"</div>";

echo"<div class='mySlides fade'>";
  echo"<div class='numbertext'>5 / 5</div>";
  echo"<img src='resource/bimg/$im_5' style='width:1000px; height:600px'>";
